...
- **clear_002** (clear): confidence=0.69, consistency=0.92, completeness=0.75, auto_routed=False. Clear request type, contact, and heat-wave context makes urgency unambiguous.
...
**Expected Calibration Error (ECE): 0.399**
...
| 0.6–0.8 | 4 | 68.8% | 0.0% | -68.8% |
| 0.8–1.0 | 13 | 97.4% | 84.6% | -12.8% |
...
**Reading the 0.6–0.8 bucket (largest over-confidence gap, -68.8%):** only 4 message(s) in this bucket, so treat as a signal to watch rather than a conclusion -- but this is the dangerous direction (confidence overstating actual correctness), and it's driven by the same kind of borderline urgency-label disagreement documented in "What broke it, and how" above, not a new failure mode.
